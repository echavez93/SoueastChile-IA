    ...
    <div className={"mm" + (open ? " mm--open" : "")} role="dialog" aria-hidden={!open} aria-label="Menú principal">
      ...
      <div className="mm__shell">
        ...
        <section className="mm__right">
          {state === "initial" ? (
            <>
              <div className="mm__hero" style={{ backgroundImage: "url('assets/home-s06-render.png')" }} role="img" aria-label={destacados[0] ? `SOUEAST ${destacados[0].nombre}` : "SOUEAST"} />
                ...
                {(lineupModelsBySection[activeCat] || []).map((m, i) => {
                  ...
                  <li key={i}>
                    <a href={modelHref} onClick={onClose}>
                      <div style={{ aspectRatio: "16/9", backgroundImage: "url('assets/home-s06-render.png')", backgroundSize: "contain", backgroundRepeat: "no-repeat", backgroundPosition: "center", backgroundColor: "#f3f3f1" }} role="img" aria-label={m.nombre} />
