...
<section className="hero" id="home">
    <img className="hero__bg" src={window.__resources.heroImg} alt="" />
...
const ModelosSection = () => {
  const modelos = [
    { name: "S06",      tag: "Lanzamiento",        img: window.__resources.s06Img,      href: "modelo-s06.html" },
    { name: "S06 PHEV", tag: "Híbrido enchufable", img: window.__resources.s06PhevImg, href: "modelo-s06-phev.html" },
    { name: "S07",      tag: "Lanzamiento",        img: window.__resources.s07Img,      href: "modelo-s07.html" },
    { name: "S09",      tag: "Próximamente",       img: window.__resources.s09Img,      href: "modelo-s09.html" },
  ];
...
const NoticiasSection = () => {
  const items = [
    { date: "5 ENERO, 2026", title: "Soueast avanza a paso agigantado: Inauguró showroom exclusivo en Movicenter", label: "noticia 01", img: window.__resources.news1Img, href: "#noticia-1" },
    { date: "20 DICIEMBRE, 2025", title: "Soueast: la nueva marca oriental que irrumpe en el mercado automotriz chileno", label: "noticia 02", img: window.__resources.news2Img, href: "#noticia-2" },
  ];
